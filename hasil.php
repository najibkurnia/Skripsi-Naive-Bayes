              ...
              <table align="text-center" class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <button type="button" class='d-none d-sm-inline-block btn btn-sm btn-success shadow-sm' data-toggle="modal" data-target="#view<?php echo $data['id_hasil']; ?>"><span aria-hidden="true"></span>Detail</button>
                      <div class="modal fade" id="view<?php echo $data['id_hasil'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      ...
                      <div class="modal-body">
                        <form action="" method="POST" role="form">
                          <div class="form-group">
                            <label for="id_hasil">Id Hasil                                : <?php echo $data['id_hasil'];?> </label>
                          </div>
                          <div class="form-group">
                            <label for="nama">Nama Karyawan                               : <?php echo $data['nama'];?></label>
                          </div> 
                          <div class="form-group">
                            <label for="pendidikan_terakhir">Pendidikan Terakhir          : <?php echo $data['pendidikan_terakhir'];?></label>
                          </div> 
                          <div class="form-group">
                            <label for="disiplin">Disiplin                                : <?php echo $data['disiplin'];?></label>
                          </div>
                          <div class="form-group">
                            <label for="teamwork">Teamwork                                : <?php echo $data['teamwork'];?></label>
                          </div>
                          <div class="form-group">
                            <label for="leadership">Leadership                            : <?php echo $data['leadership'];?></label>
                          </div>
                          <div class="form-group">
                            <label for="kepatuhan">Kepatuhan                              : <?php echo $data['kepatuhan'];?></label>
                          </div>
                          <div class="form-group">
                            <label for="kejujuran">Kejujuran                              : <?php echo $data['kejujuran'];?></label>
                          </div>
                          <div class="form-group">
                            <label for="inisiatif">Inisiatif                              : <?php echo $data['inisiatif'];?></label>
                          </div>
                          </div>
                          <div class="form-group">
                            <label for="hasil_baik">Hasil Baik              : <?php echo $data['hasil_baik'];?></label>
                          </div>
                          <div class="form-group">
                            <label for="hasil_normal">Hasil Normal          : <?php echo $data['hasil_normal'];?></label>
                          </div>
                          <div class="form-group">
                            <label for="hasil_kurang">Hasil Kurang          : <?php echo $data['hasil_kurang'];?></label>
                          </div>                      
